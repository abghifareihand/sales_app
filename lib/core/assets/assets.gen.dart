...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/image_product.png
  ...
  /// List of all assets
  List<AssetGenImage> get values => [imageProduct, imageStore, logo];
}
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/icon_min.svg
  SvgGenImage get iconMin => const SvgGenImage('assets/svg/icon_min.svg');

  /// File path: assets/svg/icon_outlet.svg
  SvgGenImage get iconOutlet => const SvgGenImage('assets/svg/icon_outlet.svg');

  /// File path: assets/svg/icon_person.svg
  SvgGenImage get iconPerson => const SvgGenImage('assets/svg/icon_person.svg');

  /// File path: assets/svg/icon_plus.svg
  SvgGenImage get iconPlus => const SvgGenImage('assets/svg/icon_plus.svg');

  /// File path: assets/svg/icon_product.svg
  SvgGenImage get iconProduct =>
      const SvgGenImage('assets/svg/icon_product.svg');
  ...
  SvgGenImage get iconSuccess =>
      const SvgGenImage('assets/svg/icon_success.svg');

  /// File path: assets/svg/icon_transaction.svg
  SvgGenImage get iconTransaction =>
      const SvgGenImage('assets/svg/icon_transaction.svg');
