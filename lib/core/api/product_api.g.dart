...
class _ProductApi implements ProductApi {
  ...
  @override
  Future<HttpResponse<ProductResponse>> products() async {
  ...
  Future<HttpResponse<ApiResponse>> returnStock({
    required ReturnStockRequest request,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<HttpResponse<ApiResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/products/return-stock',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
